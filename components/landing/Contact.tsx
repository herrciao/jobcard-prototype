      ...
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 text-lg">
            Questions about JobCard? Want a demo for your shop? We&apos;d love to hear from you.
          </p>
        </div>
        ...
        {status === 'success' ? (
          <div className="bg-green-50 border border-green-200 rounded-2xl p-8 text-center">
            ...
            <h3 className="text-green-800 font-semibold text-lg mb-1">Message sent!</h3>
            <p className="text-green-700 text-sm">We&apos;ll get back to you within 1 business day.</p>
          </div>
        ) : (
